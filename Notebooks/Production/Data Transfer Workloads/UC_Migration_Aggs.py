...
(spark.readStream
      ...
      .table("hive_metastore.ademianczuk.ad_dlt_dts2_aggs")
      .writeStream
      .format("delta")
      .outputMode("append")
      .option("checkpointLocation", "/FileStore/Users/andrij.demianczuk@databricks.com/tmp/dts_daily_aggs_cp")
      .toTable("field_demos.canwest_sa.ad_dlt_dts2_aggs")
)
