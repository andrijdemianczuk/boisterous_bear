...
(spark.readStream
      ...
      .table("hive_metastore.ademianczuk.ad_dlt_dts2_daily_temps")
      .writeStream
      .format("delta")
      .outputMode("append")
      .option("checkpointLocation", "/FileStore/Users/andrij.demianczuk@databricks.com/tmp/dts_daily_avg_cp")
      .toTable("field_demos.canwest_sa.ad_dlt_dts2_daily_temps")
)
