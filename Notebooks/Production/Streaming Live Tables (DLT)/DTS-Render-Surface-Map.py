...
# MAGIC <img src="https://github.com/andrijdemianczuk/boisterous_bear/blob/main/Notebooks/Production/Streaming%20Live%20Tables%20(DLT)/web.glasfaserkabel.jpeg?raw=true" width=750/>
...
# MAGIC
# MAGIC <img src="https://github.com/andrijdemianczuk/boisterous_bear/blob/main/Notebooks/Production/Streaming%20Live%20Tables%20(DLT)/Screenshot%202022-12-12%20at%201.47.25%20PM.png?raw=true" width=750/>
# MAGIC
...
# MAGIC
# MAGIC <img src="https://github.com/andrijdemianczuk/boisterous_bear/blob/main/Notebooks/Production/Streaming%20Live%20Tables%20(DLT)/Screenshot%202022-12-12%20-%20segmented.jpg?raw=true" width=750 />
...
samp = spark.table("hive_metastore.ademianczuk.ad_dlt_dts2_melted")
...
df = spark.table("hive_metastore.ademianczuk.ad_dlt_dts2_seq").filter(F.col("well") == "01-01P")
